...
* remaining life expectancy threshold:
    ...
    + Ryder (1975): 10 years left

    + Siegel (1993): 10 or 15 years left
    
    + Sanderson and Scherbov (2008): 15 years left
...
# Prospective ageing in Specially selected countries

* Old age threshold: 15 years remaining life expectancy
* 
...
```{r echo = FALSE}
knitr::include_graphics("figures/pyramid_65_Slovenia_1980-2015.gif")
```
---
...
```{r echo = FALSE}
knitr::include_graphics("figures/pyramid_65_Slovenia_2015-2050.gif")
```
